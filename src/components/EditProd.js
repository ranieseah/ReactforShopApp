...
const EditProd = (props) => {
  ...
  const handleAdd = () => {
    ...
    if (
      ...
      fetch("http://127.0.0.1:8000/shop/update-product/", {
        method: "PUT",
        headers: {
  ...
  const handleRemove = () => {
    fetch("http://127.0.0.1:8000/shop/del-product/", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer " + props.token,
  ...
  useEffect(()=> {
fetch("http://127.0.0.1:8000/shop/product-details/", {
  method: "POST",
  ...
  return (
    <Container maxWidth="sm">
      ...
      <Stack spacing={2}>
        ...
        <Button variant="contained" color="warning" size="large" onClick={handleRemove}>
          Remove from Shelves!
        </Button>
      </Stack>
    </Container>
